# Enable Assembly Workbench for ANVIL CAD
# Run this script if Assembly workbench is not visible
param([switch]$NonInteractive)

Write-Host "=========================================="
Write-Host "  ANVIL CAD - Enable Assembly Workbench"
Write-Host "=========================================="
Write-Host ""
...
if (Test-Path $userCfg) {
    ...
    elseif ($content -match '<FCParamGroup Name="Enabled">') {
        ...
        Write-Host '5. Click OK and restart ANVIL CAD'
    }
}
else {
    ...
    Write-Host "1. Launch ANVIL CAD (it will create user.cfg)"
    Write-Host "2. Close ANVIL CAD"  
    ...
    Write-Host '4. Restart ANVIL CAD'
}

Write-Host ""
Write-Host "=========================================="
Write-Host "Please restart ANVIL CAD to see changes"
Write-Host "=========================================="
Write-Host ""
