...
"""BNC CAD - Force Workbench Selector Toolbar to Always Show"""
        ...
        for toolbar in toolbars:
            ...
            if "workbench" in toolbar_name.lower() and "selector" in toolbar_name.lower():
                if not toolbar.isVisible():
                    ...
                    toolbar.show()
                    FreeCAD.Console.PrintLog(f"BNC CAD: Showed workbench toolbar: {toolbar_name}\n")
            ...
            if "workbench" in toolbar_name.lower() and "combo" in toolbar_name.lower():
                if toolbar.isVisible():
                    ...
                    toolbar.hide()
                    FreeCAD.Console.PrintLog(f"BNC CAD: Hid workbench dropdown: {toolbar_name}\n")
            ...
            if "workbench" in combo_name.lower():
                ...
                if isinstance(parent_toolbar, QtWidgets.QToolBar):
                    if parent_toolbar.isVisible():
                        ...
                        parent_toolbar.hide()
                        FreeCAD.Console.PrintLog(f"BNC CAD: Hid combo parent toolbar: {parent_toolbar.objectName()}\n")
...
def start_enforcement():
    ...
    FreeCAD.Console.PrintLog("BNC CAD: Workbench toolbar enforcement started\n")
